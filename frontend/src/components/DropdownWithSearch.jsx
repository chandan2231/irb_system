...
import { InputLabel, FormControl, Select, TextField, ListSubheader, InputAdornment, MenuItem, FormHelperText } from '@mui/material';
    ...
    return (
            <FormControl required fullWidth>
                ...
                >  
                    ...
                    {activeOptions ? activeOptions.map((activeList, index) => (
                        <MenuItem 
                            key={index} 
                            value={activeList.id} 
