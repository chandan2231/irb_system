...
export const userSignin = createAsyncThunk("Auth/userSignin",
...
export const sendUsername = createAsyncThunk("Auth/sendUsername",
  async (data, { rejectWithValue }) => {
    try {
        const response = await ApiCall({
            method: "POST",
...
export const validateUser = createAsyncThunk("Auth/validateUser",
  async (data, { rejectWithValue }) => {
