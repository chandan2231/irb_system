            ...
            {adverseEventById && (
              <>
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      value={adverseEventById[0]?.protocol_number}
                    />
                  </Box>
                </Form.Group>
                <Form.Group
                ...
                >
                  <FormControl>
                    <div className="highlight-text">
                      ...
                      that requires intervention, and/or may jeopardize the
                      health of the research participant
                    </div>
                  </FormControl>
                </Form.Group>
                <Form.Group
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      value={adverseEventById[0]?.participant_id_number}
                    />
                  </Box>
                </Form.Group>
                <Form.Group
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="event_end_date"
                      name="event_end_date"
                      value={moment(adverseEventById[0]?.event_end_date).format(
                        "DD-MM-YYYY"
                      )}
                    />
                  </Box>
                ...
                <Form.Group as={Col} controlId="validationFormik04">
                  <FormControl>
                    <FormLabel id="demo-row-radio-buttons-group-label">
                      Was the study discontinued for this participant as a
                      result of the event?
                    </FormLabel>
                    <RadioGroup
                      row
                ...
                >
                  <FormControl>
                    <div className="highlight-text">
                      ...
                      nature of the event. This form must be approved of by the
                      PI prior to submission. Your electronic signature below
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="person_name"
                      name="person_name"
                      value={adverseEventById[0]?.person_name}
                    />
                  </Box>
                </Form.Group>
                <Form.Group
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="email"
                      name="email"
                      value={adverseEventById[0]?.email}
                    />
                  </Box>
                </Form.Group>
                <Form.Group
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="phone"
                      name="phone"
                      value={adverseEventById[0]?.phone}
                    />
                  </Box>
                </Form.Group>
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="your_name"
                      name="your_name"
                      value={adverseEventById[0]?.your_name}
                    />
                  </Box>
                  <div className="highlight-text">
