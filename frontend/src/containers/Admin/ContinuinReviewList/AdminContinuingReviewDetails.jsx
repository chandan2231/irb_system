...
const AdminContinuingReviewDetails = () => {
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <h2 className="ml-20">
        Continuin Review Details ({continuinReviewDetails.protocolId})
      </h2>
      ...
      <CustomTabPanel value={value} index={0}>
        <RiskAssessment
          ...
          riskAssessmentDetails={continuinReviewDetailsById?.risk_assessment}
        />
      </CustomTabPanel>
      ...
      <CustomTabPanel value={value} index={3}>
        <ResearchProgress
          continuinReviewDetails={continuinReviewDetails}
          researchProgressDetails={
            continuinReviewDetailsById?.research_progress_info
          }
        />
      </CustomTabPanel>
    </Box>
