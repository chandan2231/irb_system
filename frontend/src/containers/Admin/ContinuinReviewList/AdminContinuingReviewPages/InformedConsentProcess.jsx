...
function InformedConsentProcess({continuinReviewDetails, informedConsentProcessDetails}) {
            ...
            <form onSubmit={handleSubmitData}>
                ...
                <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                    <Box sx={{width: '100%', maxWidth: '100%'}}>
                        <TextField fullWidth label="Which version of the ICF are you currently using? *" id="icf_version" name="icf_version" defaultValue={informedConsentProcessDetails?.performing_consent} />
                    </Box>
                </Form.Group>
                ...
                <Form.Group as={Col} controlId="validationFormik01">
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="challenges_faced">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={informedConsentProcessDetails?.challenges_faced === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No"  checked={informedConsentProcessDetails?.challenges_faced === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik01">
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="changes_consent">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes"  checked={informedConsentProcessDetails?.changes_consent === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={informedConsentProcessDetails?.changes_consent === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik01">
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="ensuring_list">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={informedConsentProcessDetails?.ensuring_list === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={informedConsentProcessDetails?.ensuring_list === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
