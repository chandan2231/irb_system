      ...
      <form onSubmit={handleSubmitData}>
        ...
        >
          <Box sx={{ width: '100%', maxWidth: '100%' }}>
            <TextField
              ...
              value={researchProgressDetails?.subjects_enrolled}
            />
          </Box>
        </Form.Group>
        <h4>Question 2</h4>
        ...
        >
          <Box sx={{ width: '100%', maxWidth: '100%' }}>
            <TextField
              ...
              value={researchProgressDetails?.discontinued_subjects}
            />
          </Box>
        </Form.Group>
        <div style={{ marginLeft: '0px' }}>
          ...
          >
            <Box sx={{ width: '100%', maxWidth: '100%' }}>
              <TextField
                ...
                id="sub_withdrew"
                name="sub_withdrew"
                value={researchProgressDetails?.sub_withdrew}
              />
            </Box>
          </Form.Group>
          {researchProgressDetails?.sub_withdrew >= 1 && (
            <div className="mt-mb-20">
              ...
              <p className="explain_text">
                {researchProgressDetails?.withdrawal_reason_explain}
              </p>
            </div>
          )}
          <Form.Group
          ...
          >
            <Box sx={{ width: '100%', maxWidth: '100%' }}>
              <TextField
                ...
                value={
                  researchProgressDetails?.sub_terminated_before_completion
                }
              />
            </Box>
          </Form.Group>
          {researchProgressDetails?.sub_terminated_before_completion >= 1 && (
            <div className="mt-mb-20">
              ...
              <p className="explain_text">
                {researchProgressDetails?.termination_reason_explain}
              </p>
            </div>
          )}
        </div>
        ...
        >
          <Box sx={{ width: '100%', maxWidth: '100%' }}>
            <TextField
              ...
              value={researchProgressDetails?.occured_adverse_event}
            />
          </Box>
        </Form.Group>
          ...
          <FormControl>
            ...
            >
              <FormControlLabel
                ...
                label="Yes"
                checked={
                  researchProgressDetails?.adverse_event_submission === 'Yes'
                }
              />
              <FormControlLabel
                value="No"
        ...
        {researchProgressDetails?.adverse_event_submission === 'No' && (
          <>
            <div className="mt-mb-20">
              <FormLabel>
                What was the reason the adverse events were not reported to the
                IRB?
              </FormLabel>
              <p className="explain_text">
                {researchProgressDetails?.adverse_event_not_reported_explain}
              </p>
            </div>
            <div className="mt-mb-20">
              <FormLabel>
                Please describe the adverse events including what occurred, the
                timeline in which it occurred, and the time at which the study
                personnel became aware of the adverse event
              </FormLabel>
              <p className="explain_text">
                {researchProgressDetails?.adverse_event_explain}
              </p>
            </div>
            ...
            >
              <InputLabel
                ...
                className="mt-mb-10"
              >
                Uploaded any supporting documents
              </InputLabel>
              {researchProgressDetails?.documents?.length > 0 &&
                researchProgressDetails?.documents?.map((docList, index) => {
        ...
        >
          <Box sx={{ width: '100%', maxWidth: '100%' }}>
            <TextField
              ...
              value={researchProgressDetails?.subjecte_completed}
            />
          </Box>
        </Form.Group>
        <h4>Question 5</h4>
          ...
          <FormControl>
            ...
            >
              ...
              <FormControlLabel
                ...
                control={<Radio />}
                label="No"
                checked={researchProgressDetails?.last_approval_change === 'No'}
              />
            </RadioGroup>
          </FormControl>
        </Form.Group>
            ...
            <FormControl>
              ...
              >
                <FormControlLabel
                  ...
                  label="Yes"
                  checked={
                    researchProgressDetails?.last_approval_change_report ===
                    'Yes'
                  }
                />
                <FormControlLabel
        ...
        {researchProgressDetails?.last_approval_change_report === 'No' && (
          <div className="mt-mb-20">
            ...
            <p className="explain_text">
              {researchProgressDetails?.changes_not_reported_to_irb}
            </p>
          </div>
        )}
        <Form.Group
