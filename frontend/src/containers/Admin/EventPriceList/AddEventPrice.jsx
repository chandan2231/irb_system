...
const AddEventPrice = ({ open, onClose, addNewData, title }) => {
    ...
    const [eventTypeList, setEventTypeList] = React.useState([{name: 'Protocol Submission', id: 'Protocol Submission'}, {name: 'Protocol Revision', id: 'Protocol Revision'}, {name: 'Continue Yearly Review', id: 'Continue Yearly Review'}]);
    const modalStyles = {
        inputFields: {
            display: 'flex',
