...
function InvestigatorInformationForm({protocolTypeDetails, investicatorProtocolInformation}) {
    ...
    console.log('investicatorProtocolInformation', investicatorProtocolInformation)
    const trainingCompletedArr = investicatorProtocolInformation?.training_completed?.split(",");
    return (
        <Row>
            <form onSubmit={handleSubmitData}>
                <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Investigator Name " id="investigator_name" name="investigator_name" value={investicatorProtocolInformation?.investigator_name} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Investigator Email " id="investigator_email" name="investigator_email" value={investicatorProtocolInformation?.investigator_email} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Sub-Investigator Name" id="sub_investigator_name" name="sub_investigator_name" value={investicatorProtocolInformation?.sub_investigator_name} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Sub-Investigator Email" id="sub_investigator_email" name="sub_investigator_email" value={investicatorProtocolInformation?.sub_investigator_email} />
                    </Box>
                </Form.Group>

                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Additional Study personnel name" id="additional_study_name" name="additional_study_name" value={investicatorProtocolInformation?.additional_study_name} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Additional Study personnel email address" id="additional_study_email" name="additional_study_email" value={investicatorProtocolInformation?.additional_study_email} />
                    </Box>
                </Form.Group>
                <h3>Investigational/Research Location:</h3>
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Name of site " id="site_name" name="site_name" value={investicatorProtocolInformation?.site_name} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Address of site " id="site_address" name="site_address" value={investicatorProtocolInformation?.site_address} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik01">
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="more_site">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.more_site === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.more_site === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                    investicatorProtocolInformation?.more_site === 'Yes' && (
                        <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                            <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                <TextField fullWidth label="Name and address of site " id="site_name_address" name="site_name_address" value={investicatorProtocolInformation?.site_name_address} />
                            </Box>
                        </Form.Group>
                    )
                }
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Full protocol title " id="protocol_title" name="protocol_title" value={investicatorProtocolInformation?.protocol_title} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Protocol Number " id="protocol_number" name="protocol_number" value={investicatorProtocolInformation?.protocol_number} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik03" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="Your initials below confirm that your site will only enroll subjects that meet criteria for inclusion in the study " name="study_criteria" id='study_criteria' value={investicatorProtocolInformation?.study_criteria} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik03" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="How many subjects do you expect to enroll at your site(s) " name="subject_number" id='subject_number' value={investicatorProtocolInformation?.subject_number} />
                    </Box>
                </Form.Group>

                <Form.Group as={Col} controlId="validationFormik03" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="What is your site number assigned by the sponsor" name="site_number" id='site_number' value={investicatorProtocolInformation?.site_number} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik02" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="disapproved_or_withdrawn">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.disapproved_or_withdrawn === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.disapproved_or_withdrawn === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="oversite">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.oversite === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.oversite === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="immediate_family">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.immediate_family === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.immediate_family === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="stock_ownership">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.stock_ownership === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.stock_ownership === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="property_interest">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.property_interest === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.property_interest === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="financial_agreement">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.financial_agreement === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.financial_agreement === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="server_position">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.server_position === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.server_position === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="influence_conduct">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.influence_conduct === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.stock_ownership === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="interest_conflict">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.interest_conflict === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.interest_conflict === 'No'} />
                            <FormControlLabel value="N/A" control={<Radio />} label="N/A" checked={investicatorProtocolInformation?.interest_conflict === 'N/A'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik04" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="fda_audit">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.fda_audit === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.fda_audit === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
                ...
                <Form.Group as={Col} controlId="validationFormik01" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="involved_years">
                            <FormControlLabel value="New to research-1 year" control={<Radio />} label="New to research-&lt;1 year" checked={investicatorProtocolInformation?.involved_years === 'New to research-1 year'} />
                            <FormControlLabel value="1-5 years" control={<Radio />} label="1-5 years" checked={investicatorProtocolInformation?.involved_years === '1-5 years'} />
                            <FormControlLabel value="6 years or more" control={<Radio />} label="6 years or more" checked={investicatorProtocolInformation?.involved_years === '6 years or more'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                ...
                <Form.Group as={Col} controlId="validationFormik08" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="What is the investigator's NPI if applicable" id="investigators_npi" name="investigators_npi" value={investicatorProtocolInformation?.investigators_npi} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik01" className='mt-mb-20'>
                    <FormControl>
                        <FormLabel id="demo-row-radio-buttons-group-label">What training in the field of human subjects protection has the investigator completed?</FormLabel>
                        {
                            completedTraining.map((trainingList, index) => {
                                return(<FormControlLabel key={index} control={<Checkbox />} label={trainingList.label} value={trainingList.value} checked={trainingCompletedArr?.find(id => Number(id) === Number(trainingList.value))} />)
                            })
                        }
                    </FormControl>
                </Form.Group>
                ...
                <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                        <TextField fullWidth label="What is the current number of research studies supervised by the investigator?" id="investigator_research_number" name="investigator_research_number" value={investicatorProtocolInformation?.investigator_research_number} />
                    </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik01" className='mt-mb-20'>
                    <FormControl>
                        ...
                        <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="pending_or_active_research">
                            <FormControlLabel value="Yes" control={<Radio />} label="Yes" checked={investicatorProtocolInformation?.pending_or_active_research === 'Yes'} />
                            <FormControlLabel value="No" control={<Radio />} label="No" checked={investicatorProtocolInformation?.pending_or_active_research === 'No'} />
                        </RadioGroup>
                    </FormControl>
                </Form.Group>
                {
