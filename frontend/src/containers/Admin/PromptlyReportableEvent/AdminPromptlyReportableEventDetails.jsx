            ...
            <>
                ...
                <FormControl>
                  ...
                  >
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.submitter_type ===
                        "Sponsor or CRO (Contract Research Organization)"
                      }
                    />
                    <FormControlLabel
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    defaultValue={
                      promptlyReportableEventById[0]?.irb_protocol_number
                    }
                  />
                </Box>
              </Form.Group>
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    id="sponsor_name"
                    name="sponsor_name"
                    defaultValue={promptlyReportableEventById[0]?.sponsor_name}
                  />
                </Box>
              </Form.Group>
              <Form.Group as={Col} controlId="validationFormik01">
                <FormControl>
                  ...
                  >
                    ...
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.described_category ===
                        "Written report from federal agency (ie: FDA 483)"
                      }
                    />
                    <FormControlLabel
                    ...
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.described_category ===
                        "Suspension or early termination by the sponsor, investigator, or institution"
                      }
                    />
                    <FormControlLabel
                    ...
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.described_category ===
                        "Change in financial interest disclosure"
                      }
                    />
                    <FormControlLabel
                    ...
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.described_category ===
                        "Protocol deviation made without prior IRB approval to eliminate immediate harm to subject"
                      }
                    />
                    <FormControlLabel
                    ...
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.described_category ===
                        "Adverse event that requires change to the protocol or consent"
                      }
                    />
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.described_category ===
                        "Adverse event that does NOT require change to the protocol or consent"
                      }
                    />
                    <FormControlLabel
                      ...
                      checked={
                        promptlyReportableEventById[0]?.described_category ===
                        "Sponsor/CRO/monitor requests report to IRB"
                      }
                    />
                    <FormControlLabel
                      value="Other"
                ...
                <FormControl>
                  ...
                  >
                    <FormControlLabel
                      ...
                      label="Yes"
                      checked={
                        promptlyReportableEventById[0]?.involved_subject ===
                        "Other"
                      }
                    />
                    <FormControlLabel
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    id="date_problem_discovered"
                    name="date_problem_discovered"
                    defaultValue={moment(
                      promptlyReportableEventById[0]?.date_problem_discovered,
                    ).format("DD-MM-YYYY")}
                  />
                </Box>
              </Form.Group>
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    defaultValue={moment(
                      promptlyReportableEventById[0]?.date_of_occurrence,
                    ).format("DD-MM-YYYY")}
                  />
                </Box>
              </Form.Group>
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    id="date_reported_to_sponsor"
                    name="date_reported_to_sponsor"
                    defaultValue={moment(
                      promptlyReportableEventById[0]?.date_reported_to_sponsor,
                    ).format("DD-MM-YYYY")}
                  />
                </Box>
              </Form.Group>
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  ...
                  <p className="explain_text">
                    {promptlyReportableEventById[0]?.describe_problem}
                  </p>
                </Box>
              </Form.Group>
              <Form.Group
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  ...
                  <p className="explain_text">
                    {promptlyReportableEventById[0]?.action_taken}
                  </p>
                </Box>
              </Form.Group>
              <Form.Group
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  ...
                  <p className="explain_text">
                    {promptlyReportableEventById[0]?.plan_action_taken}
                  </p>
                </Box>
              </Form.Group>
              <Form.Group
                ...
                <FormControl>
                  ...
                  >
                    <FormControlLabel
                      ...
                      label="Yes"
                      checked={
                        promptlyReportableEventById[0]?.subject_harmed === "Yes"
                      }
                    />
                    <FormControlLabel
                      value="No"
                      ...
                      label="No"
                      checked={
                        promptlyReportableEventById[0]?.subject_harmed === "No"
                      }
                    />
                  </RadioGroup>
                </FormControl>
                ...
                <FormControl>
                  ...
                  >
                    <FormControlLabel
                      ...
                      label="Yes"
                      checked={
                        promptlyReportableEventById[0]?.protocol_change ===
                        "Yes"
                      }
                    />
                    <FormControlLabel
                      ...
                      label="No"
                      checked={
                        promptlyReportableEventById[0]?.protocol_change === "No"
                      }
                    />
                  </RadioGroup>
                </FormControl>
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  ...
                  <p className="explain_text">
                    {promptlyReportableEventById[0]?.question_not_covered}
                  </p>
                </Box>
              </Form.Group>
              <Form.Group
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    id="person_name"
                    name="person_name"
                    defaultValue={promptlyReportableEventById[0]?.person_name}
                  />
                </Box>
                {errors.person_name && (
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    id="email"
                    name="email"
                    defaultValue={promptlyReportableEventById[0]?.email}
                  />
                </Box>
              </Form.Group>
              <Form.Group
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    id="phone"
                    name="phone"
                    defaultValue={promptlyReportableEventById[0]?.phone}
                  />
                </Box>
              </Form.Group>
              ...
              >
                <Box sx={{ width: "100%", maxWidth: "100%" }}>
                  <TextField
                    ...
                    id="your_name"
                    name="your_name"
                    defaultValue={promptlyReportableEventById[0]?.your_name}
                  />
                </Box>
