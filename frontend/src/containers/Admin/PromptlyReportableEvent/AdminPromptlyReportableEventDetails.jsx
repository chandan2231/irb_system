            ...
            {promptlyReportableEventById && (
              <>
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="sponsor_name"
                      name="sponsor_name"
                      value={promptlyReportableEventById[0]?.sponsor_name}
                    />
                  </Box>
                </Form.Group>
                <Form.Group as={Col} controlId="validationFormik01">
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <FormLabel id="demo-row-radio-buttons-group-label">
                      Describe the actions you plan to take to correct the
                  ...
                  <FormControl>
                    ...
                    >
                      <FormControlLabel
                        ...
                        label="Yes"
                        checked={
                          promptlyReportableEventById[0]?.subject_harmed ===
                          "Yes"
                        }
                      />
                      <FormControlLabel
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="person_name"
                      name="person_name"
                      value={promptlyReportableEventById[0]?.person_name}
                    />
                  </Box>
                  {errors.person_name && (
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="email"
                      name="email"
                      value={promptlyReportableEventById[0]?.email}
                    />
                  </Box>
                </Form.Group>
                <Form.Group
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="phone"
                      name="phone"
                      value={promptlyReportableEventById[0]?.phone}
                    />
                  </Box>
                </Form.Group>
                ...
                >
                  <Box sx={{ width: "100%", maxWidth: "100%" }}>
                    <TextField
                      ...
                      id="your_name"
                      name="your_name"
                      value={promptlyReportableEventById[0]?.your_name}
                    />
                  </Box>
