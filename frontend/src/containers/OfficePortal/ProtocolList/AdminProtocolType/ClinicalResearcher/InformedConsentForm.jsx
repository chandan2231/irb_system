        ...
        >
          <Box sx={{ width: "100%", maxWidth: "100%" }}>
            <FormLabel id="demo-row-radio-buttons-group-label">
              ...
              formatted with your information. Please answer the questions below
              so that we may include it in the document
            </FormLabel>
          </Box>
        </Form.Group>
        <Form.Group
        ...
        >
          <Box sx={{ width: "100%", maxWidth: "100%" }}>
            <TextField
              ...
              value={consentInformation?.principal_investigator_name}
            />
          </Box>
        </Form.Group>
        <Form.Group
        ...
        >
          <Box sx={{ width: "100%", maxWidth: "100%" }}>
            <TextField
              ...
              id="site_address"
              name="site_address"
              value={consentInformation?.site_address}
            />
          </Box>
        </Form.Group>
        <Form.Group
        ...
        >
          <Box sx={{ width: "100%", maxWidth: "100%" }}>
            <TextField
              ...
              value={consentInformation?.additional_site_address}
            />
          </Box>
        </Form.Group>
        <Form.Group
        ...
        >
          <Box sx={{ width: "100%", maxWidth: "100%" }}>
            <TextField
              ...
              id="primary_phone"
              name="primary_phone"
              value={consentInformation?.primary_phone}
            />
          </Box>
        </Form.Group>
        <Form.Group
        ...
        >
          <Box sx={{ width: "100%", maxWidth: "100%" }}>
            <TextField
              ...
              value={consentInformation?.always_primary_phone}
            />
          </Box>
        </Form.Group>
        <Form.Group
          ...
          <FormControl>
            ...
            >
              <FormControlLabel
                ...
                control={<Radio />}
                label="Yes"
                checked={consentInformation?.site_electronic_consent === "Yes"}
              />
              <FormControlLabel
                value="No"
                control={<Radio />}
                label="No"
                checked={consentInformation?.site_electronic_consent === "No"}
              />
            </RadioGroup>
          </FormControl>
        </Form.Group>
