...
function InformedConsentForm({ protocolTypeDetails, informedConsent }) {
    ...
    const [showElectronicConsentField, setShowElectronicConsentField] = React.useState(false);
    ...
    useEffect(() => {
        if (informedConsent) {
            setFormData({
                principal_investigator_name: informedConsent?.principal_investigator_name || '',
            ...
            setShowElectronicConsentField(informedConsent?.site_electronic_consent === 'Yes');
        }
                ...
                <form onSubmit={handleSubmitData}>
                    <Form.Group as={Col} controlId="validationFormik03" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <FormLabel id="demo-row-radio-buttons-group-label">
                                The IRB will provide your site with an informed consent form formatted with your information. Please answer the questions below so that we may include it in the document
                            </FormLabel>
                        </Box>
                    </Form.Group>
                    <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="Principal Investigator name *" id="principal_investigator_name" name="principal_investigator_name" onChange={handleChange} value={formData.principal_investigator_name} />
                        </Box>
                        {errors.principal_investigator_name && <div className="error">{errors.principal_investigator_name}</div>}
                    </Form.Group>
                    <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="Site Address *" id="site_address" name="site_address" onChange={handleChange} value={formData.site_address} />
                        </Box>
                        {errors.site_address && <div className="error">{errors.site_address}</div>}
                    </Form.Group>
                    <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="Additional Site Address" id="additional_site_address" name="additional_site_address" onChange={handleChange} value={formData.additional_site_address} />
                        </Box>
                    </Form.Group>
                    <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="Primary phone number to be listed on the ICF (include the area code) *" id="primary_phone" name="primary_phone" onChange={handleChange} value={formData.primary_phone} />
                        </Box>
                        {errors.primary_phone && <div className="error">{errors.primary_phone}</div>}
                    </Form.Group>
                    <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="24-hour phone number to be listed on the ICF (include the area code) *" id="always_primary_phone" name="always_primary_phone" onChange={handleChange} value={formData.always_primary_phone} />
                        </Box>
                    ...
                    <Form.Group as={Col} controlId="validationFormik01" className='mt-mb-20'>
                        <FormControl>
                            ...
                            <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="site_electronic_consent" value={formData.site_electronic_consent} onChange={handleRadioButtonElectronicConsent}>
                    ...
                    {showElectronicConsentField && (
                        <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                            <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                <TextField fullWidth label="Electronic Consent Field (Example)" id="electronic_consent_field" name="electronic_consent_field"
