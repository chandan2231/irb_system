            ...
            if (isValid === true) {
                ...
                if (!formData.facing_materials) {
                    ...
                    for (let file of formData.facing_materials) {
                        let id = await uploadFile(file, { protocolId: formData.protocol_id, createdBy: formData.created_by,  protocolType: protocolTypeDetails.researchType, informationType: 'multi site sponsor protocol procedure', documentName: 'recruitment and subject-facing materials'})
                ...
                <form onSubmit={handleSubmitData}>
                    ...
                    <Form.Group as={Col} controlId="validationFormik01">
                        <FormControl>
                            ...
                            <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="irb_approval" onChange={(event) => handleRadioButtonIrbApproval(event, 'irb_approval')}>
                                <FormControlLabel value="Yes" control={<Radio />} label="Yes" />
                                <FormControlLabel value="No" control={<Radio />} label="No" />
                            </RadioGroup>
                        </FormControl>
                    ...
                    <Form.Group as={Col} controlId="validationFormik03" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            ...
                            <TextField variant="outlined" placeholder="" fullWidth name="expected_number_sites" id='expected_number_sites' rows={3} multiline onChange={handleChange} />
                        </Box>
                        ...
                        showFutureResearchAdditionTextArea === true && (
                            <Form.Group as={Col} controlId="validationFormik03" className='mt-mb-20'>
                                <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                    ...
                                    <TextField variant="outlined" placeholder="" fullWidth name="future_research_explain" id='future_research_explain' rows={3} multiline onChange={handleChange} />
                                </Box>
