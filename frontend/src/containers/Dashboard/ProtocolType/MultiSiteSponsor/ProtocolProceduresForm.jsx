      ...
      <Row>
        <form onSubmit={handleSubmitData}>
          ...
          >
            <FormControl>
              ...
              >
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("1")} />
                  }
                  value="1"
                ...
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("2")} />
                  }
                  value="2"
                ...
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("3")} />
                  }
                  value="3"
                ...
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("4")} />
                  }
                  value="4"
                ...
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("5")} />
                  }
                  value="5"
                ...
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("6")} />
                  }
                  value="6"
                  label="Asian"
                />
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("7")} />
                  }
                  value="7"
                ...
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("8")} />
                  }
                  value="8"
                  label="Multiracial"
                />
                <FormControlLabel
                  control={
                    <Checkbox checked={formData.enrolled_group.includes("9")} />
                  }
                  value="9"
                  label="Other"
                />
          ...
          >
            <Box sx={{ width: "100%", maxWidth: "100%" }}>
              <FormLabel id="demo-row-radio-buttons-group-label">
                What is the expected number of sites to participate in this
                study that will be submitted to this IRB *
              </FormLabel>
              <TextField
                variant="outlined"
                placeholder=""
                fullWidth
                name="expected_number_sites"
                id="expected_number_sites"
                rows={3}
                multiline
            ...
            {errors.expected_number_sites && (
              <div className="error">{errors.expected_number_sites}</div>
            )}
          </Form.Group>
