    ...
    useEffect(() => {
        if (researchProgress) {
            setFormData({
                ...
                withdrawal_reason_explain: researchProgress.withdrawal_reason_explain || '',
                sub_terminated_before_completion: researchProgress.sub_terminated_before_completion || '',
                termination_reason_explain: researchProgress.termination_reason_explain || '',
                occured_adverse_event: researchProgress.occured_adverse_event || '',
                adverse_event_submission: researchProgress.adverse_event_submission || '',
                adverse_event_not_reported_explain: researchProgress.adverse_event_not_reported_explain || '',
                ...
                last_approval_change_report: researchProgress.last_approval_change_report || '',
                changes_not_reported_to_irb: researchProgress.changes_not_reported_to_irb || '',
                protocol_id: continuinReviewDetails?.protocolId,
                created_by: userDetails?.id,
                q3_supporting_documents: researchProgress?.documents?.map(doc => {
            ...
            setShowAdverseEventAdditionalQuestion(researchProgress.adverse_event_submission === 'No' ? true : false);
            setShowLastApprovalChangeAdditionalQuestion(researchProgress.last_approval_change === 'Yes' ? true : false);
            setShowLastApprovalChangeReportAdditionalQuestion(researchProgress.last_approval_change_report === 'No' ? true : false);
        }
            ...
            if (isValid === true) {
                ...
                if (formData.q3_supporting_documents) {
                    for (let file of formData.q3_supporting_documents) {
                        let id = uploadFile(file, { protocolId: formData.protocol_id, createdBy: formData.created_by, protocolType: 'continuein_review', informationType: 'research_progress', documentName: 'q3_supporting_documents' })
                ...
                <form onSubmit={handleSubmitData}>
                    ...
                    <Form.Group as={Col} controlId="validationFormik06" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="Total Subjects Enrolled *" id="subjects_enrolled" name="subjects_enrolled"
                    ...
                    <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="How many subjects have discontinued their participation? *" id="discontinued_subjects" name="discontinued_subjects"
                    ...
                    <div style={{ marginLeft: '0px' }}>
                        <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                            <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                <TextField fullWidth label="Out of that number, how many subjects withdrew of their own accord *" id="sub_withdrew" name="sub_withdrew"
                            ...
                            showAdditionalQuestionWithdrew >= 1 && (
                                <div>
                                    ...
                                    <Form.Group as={Col} controlId="validationFormik03">
                                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                            <TextField variant="outlined" placeholder="Explain" fullWidth name="withdrawal_reason_explain" id='withdrawal_reason_explain' rows={3} multiline
                        ...
                        <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                            <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                <TextField fullWidth label="how many subjects were terminated before completion of the protocol by the decision of the PI, Sponsor, or other contracted research personnel *" id="sub_terminated_before_completion" name="sub_terminated_before_completion"
                        ...
                        </Form.Group>
                        {
                            showAdditionalQuestionTerminated >= 1 && (
                                <div>
                                    ...
                                    <Form.Group as={Col} controlId="validationFormik03">
                                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                            <TextField variant="outlined" placeholder="Explain" fullWidth name="termination_reason_explain" id='termination_reason_explain' rows={3} multiline
                    ...
                    <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="How many adverse events have occurred since the last approval?*" id="occured_adverse_event" name="occured_adverse_event"
                    ...
                    <Form.Group as={Col} controlId="validationFormik01">
                        <FormControl>
                            ...
                            <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="adverse_event_submission"
                                ...
                                onChange={(event) => handleAdverseEventSubmission(event, 'adverse_event_submission')}>
                        ...
                        showAdverseEventAdditionalQuestion === true && (
                            <>
                                <div className='mt-mb-20'>
                                    ...
                                    <Form.Group as={Col} controlId="validationFormik03">
                                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                            <TextField variant="outlined" placeholder="Explain" fullWidth name="adverse_event_not_reported_explain" id='adverse_event_not_reported_explain' rows={3} multiline
                                ...
                                <div className='mt-mb-20'>
                                    ...
                                    <Form.Group as={Col} controlId="validationFormik03">
                                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                            <TextField variant="outlined" placeholder="Explain" fullWidth name="adverse_event_explain" id='adverse_event_explain' rows={3} multiline
                    ...
                    <Form.Group as={Col} controlId="validationFormik07" className='mt-mb-20'>
                        <Box sx={{ width: '100%', maxWidth: '100%' }}>
                            <TextField fullWidth label="How many subject have completed the study per protocol?*" id="subjecte_completed" name="subjecte_completed"
                    ...
                    <Form.Group as={Col} controlId="validationFormik01">
                        <FormControl>
                            ...
                            <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="last_approval_change"
                                ...
                                onChange={(event) => handleLastApprovalChange(event, 'last_approval_change')}>
                                <FormControlLabel value="Yes" control={<Radio />} label="Yes" />
                                <FormControlLabel value="No" control={<Radio />} label="No" />
                            </RadioGroup>
                        </FormControl>
                            ...
                            <Form.Group as={Col} controlId="validationFormik01">
                                <FormControl>
                                    ...
                                    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="last_approval_change_report"
                                        ...
                                        onChange={(event) => handleLastApprovalChangeReport(event, 'last_approval_change_report')}>
                                        <FormControlLabel value="Yes" control={<Radio />} label="Yes" />
                                        <FormControlLabel value="No" control={<Radio />} label="No" />
                                    </RadioGroup>
                                </FormControl>
                    ...
                    }
                    {
                        showLastApprovalChangeReportAdditionalQuestion === true && (
                            <div className='mt-mb-20'>
                                ...
                                <Form.Group as={Col} controlId="validationFormik03">
                                    <Box sx={{ width: '100%', maxWidth: '100%' }}>
                                        <TextField variant="outlined" placeholder="Explain" fullWidth name="changes_not_reported_to_irb" id='changes_not_reported_to_irb' rows={3}
                                            multiline
