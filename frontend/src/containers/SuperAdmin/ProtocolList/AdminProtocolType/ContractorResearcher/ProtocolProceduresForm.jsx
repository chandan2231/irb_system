...
function ProtocolProceduresForm({
  ...
  const [explainRecurementMethodErrors, setExplainRecurementMethodErrors] =
    React.useState();
  const [explainFutureResearchErrors, setExplainFutureResearchErrors] =
    React.useState();
  const [explainStudyExcludeErrors, setExplainStudyExcludeErrors] =
    React.useState();
      ...
      <form onSubmit={handleSubmitData}>
        ...
        >
          <Box sx={{ width: "100%", maxWidth: "100%" }}>
            <TextField
              ...
              value={protocolProcedures?.research_place_name_address}
            />
          </Box>
        </Form.Group>
        <Form.Group as={Col} controlId="validationFormik01">
          <FormControl>
            ...
            >
              <FormControlLabel
                ...
                control={<Radio />}
                label="Yes"
                checked={protocolProcedures?.future_research === "Yes"}
              />
              <FormControlLabel
                value="No"
                control={<Radio />}
                label="No"
                checked={protocolProcedures?.future_research === "No"}
              />
            </RadioGroup>
          </FormControl>
        </Form.Group>
        ...
        >
          <InputLabel id="demo-simple-select-autowidth-label">
            Uploaded all recruitment and subject-facing materials
          </InputLabel>
