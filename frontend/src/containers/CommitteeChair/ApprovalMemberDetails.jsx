...
function ApprovalMemberDetails() {
    ...
    const handleSubmitData = async (e) => {
        ...
        try {
          ...
          const isValid = await chairCommitteeApprovalSchema.isValid(getValidatedform);
          if (isValid === true) {
        ...
        <Box m={theme.layoutContainer.layoutSection}>
            <Box>
                <Grid container spacing={2}>
                    ...
                    <h2 mb={2}>
                        {protocolTypeDetails.protocolId} ({protocolTypeDetails.researchType})
                    </h2>
                    </Grid>
                </Grid>
            </Box>
                ...
                <div>
                    <Accordion>
                        <AccordionSummary
                            ...
                            id="panel1-header"
                        >
                            <Typography variant="h6">Protocol Approved by Members</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Grid container spacing={2}>
                            {
                    ...
                    <Accordion sx={{ mt: 3 }}>
                        <AccordionSummary
                            ...
                            id="panel2-header"
                        >
                        <Typography variant="h6">Final Status of Study Approval</Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                            <Row className="ml-20">
                                            ...
                                            >
                                                <FormControl>
                                                    ...
                                                    >
                                                        ...
                                                        <FormControlLabel value="Approved pending changes" control={<Radio />} label="Approved pending changes" />
