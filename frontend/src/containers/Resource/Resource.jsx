...
function Resource(){
    ...
    return(
        <Box m={theme.layoutContainer.layoutSection}>
            <Box>
                <Grid container spacing={2}>
                    <Grid item xs={5} sm={5} md={8} lg={8}>
                        <Typography variant="h5" mb={2}>Resource</Typography>
                    </Grid>
            ...
            <Box>
                <AddResource open={open} onClose={() => setOpen(false)} addNewData={addNewData} />
            </Box>
            {/* <Box sx={{mt: 5}}>
                        ...
                        <Select
                            ...
                            renderValue={(selected) => {
                                if (selected.length === 0) {
                                    return <em>Search by: Resource</em>;
                                }
