      ...
      <Box className="pd-25">
        ...
        <form onSubmit={handleSubmitData} id="protocol_information">
          ...
          >
            <FormControl>
              <div className="highlight-text">
                ...
                death, is life-threatening, requires in-patient hospitalization,
                results in prolongation of current hospitalization, results in
                disability (acute or chronic), results in a birth defect, is an
                important medical event that requires intervention, and/or may
                jeopardize the health of the research participant
              </div>
            </FormControl>
          </Form.Group>
          ...
          >
            <FormControl>
              <FormLabel id="demo-row-radio-buttons-group-label">
                Which level of severity best describes the nature of the event?
              </FormLabel>
              <RadioGroup
                row
                aria-labelledby="demo-row-radio-buttons-group-label"
          ...
          {showStudyDiscontinuedAdditionTextArea === true && (
            ...
            >
              ...
              {errors.study_discontinued_explain && (
                <div className="error">{errors.study_discontinued_explain}</div>
              )}
            </Form.Group>
          )}
          <Form.Group
          ...
          >
            <FormControl>
              <div className="highlight-text">
                ...
                No other study personnel may determine the nature of the event.
                This form must be approved of by the PI prior to submission.
                Your electronic signature below guarantees that all information
                provided in this form was reviewed and completed by the PI prior
                to submission.
              </div>
            </FormControl>
          </Form.Group>
