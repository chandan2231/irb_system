...
export const saveInvestigatorInfo = (req, res) => {
    const selectQue = "select * from investigator_information where protocol_id = ?";
    db.query(selectQue, [req.body.protocol_id], (err, data) => {
        if (data.length > 0 ) {
...
export const saveInvestigatorAndProtocolInformation = (req, res) => {
    ...
    const selectQue = "select * from investigator_protocol_information where protocol_id = ?";
    db.query(selectQue, [req.body.protocol_id], (err, data) => {
        if (data.length > 0 ) {
            ...
            db.query(updateQuery, updateValues, (err, data) => {
                if (err) {
                    ...
                    let result = {}
                    result.status = 200
                    result.msg = 'Investigator and Protocol Information has been updated successfully'
                    return res.json(result)
                }
            })
        } else {
...
export const saveClinicalInformedConsent = (req, res) => {
    var datetime = new Date();
    const selectQue = "select * from clinical_consent_information where protocol_id = ?";
    db.query(selectQue, [req.body.protocol_id], (err, data) => {
        if (data.length > 0 ) {
            ...
            db.query(updateQuery, updateValues, (err, data) =>{
                if (err) {
                    ...
                    let result = {}
                    result.status = 200
                    result.msg = 'Informed Consent Information has been updated successfully'
                    return res.json(result)
                }
            })
        } else {
